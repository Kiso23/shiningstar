        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {TROPHIES.length > 0 ? (
              ...
              >
                <p style={{ color: textMute }} className="text-lg">No trophies yet. Win the tournament to earn achievements!</p>
              </motion.div>
            )}
          </div>
          ...
          >
            ...
            <div className="space-y-4">
              {TROPHIES.length > 0 ? (
                TROPHIES.map((record, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p style={{ color: textMain }} className="font-bold">{record.name}</p>
                        <p style={{ color: textMute }} className="text-sm">{record.position}</p>
                      </div>
                    </div>
                  </motion.div>
                ))
                ...
                >
                  <p style={{ color: textMute }} className="text-sm">No tournament history yet.</p>
                </motion.div>
              )}
            </div>
          </motion.div>
