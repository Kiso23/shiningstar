...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col">
      ...
      {/* Main layout — single left panel + right detail */}
      <div className="flex-1 flex overflow-hidden">

        {/* Left panel — always visible on desktop, hidden on mobile when detail is open */}
        <aside className={`
            ...
            {selected ? (
              ...
              >
                ...
                <RegistrationDetail
                  ...
                  onStatusChange={() => {
                    handleStatusChange()
                    // Refresh the selected team's status badge in the list
                    setSelected((prev) => prev ? { ...prev } : null)
                  }}
                  onDelete={() => {
                    // Clear selection and refresh list after delete
                    setSelected(null)
                    handleStatusChange()
                  }}
                />
