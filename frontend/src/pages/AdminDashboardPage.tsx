...
import ChatSupportTab from '../components/admin/ChatSupportTab'
import { useAdminAuth } from '../hooks/useAdminAuth'
import type { TeamResponse } from '../api/registrations'

type Tab = 'registrations' | 'fixtures' | 'live' | 'analytics' | 'settings' | 'chat'
...
const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'chat', label: 'Chat Support', icon: <MessageSquare className="w-4 h-4" /> },
