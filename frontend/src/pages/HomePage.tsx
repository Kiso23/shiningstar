...
import { Trophy, Calendar, MapPin, Users, ChevronRight, ArrowRight, CheckCircle, Radio, MessageSquare, Menu, X, Video, Award } from 'lucide-react'
    ...
    <div style={{ backgroundColor: bg }} className="min-h-screen overflow-x-hidden text-white">
      ...
      >
        <div className="flex items-center gap-2">
          <img src="/logo.svg" alt="SSU" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover border-2 border-green-500 shrink-0" />
